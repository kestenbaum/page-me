...
const Portfolio_DATA = [
  ...
  },
  {
    ...
    description:
      'Developing complex Single Page Applications (SPA) with efficient state management.',
    link: 'https://github.com/your-profile',
  },
  {
    id: 3,
    ...
    description:
      'Creating beautiful, maintainable user interfaces with modular and scalable styles.',
    link: 'https://github.com/your-profile',
  },
  {
    id: 4,
    ...
    description:
      'Managing CI/CD pipelines and deploying web applications to various hosting platforms.',
    link: 'https://github.com/your-profile',
  },
];
