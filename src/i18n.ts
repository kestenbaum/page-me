      ...
      en: {
        translation: {
          ...
          hero: {
            ...
            thanks: 'Thank You.',
            intro: [
              'My name is Oleksii. I’m a Web Developer from Ukraine with over 3 years of experience. I believe in deep dedication to every project, where client satisfaction is the primary goal of my career.',
              'I specialize in React, Next, JavaScript and TypeScript, with a solid understanding of web hosting and infrastructure. I approach complex challenges with an analytical mindset, ensuring clear and efficient solutions while maintaining a professional and friendly partnership with my clients.',
